...
class ProvincesLocalitiesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($provincias as $provincia) {
            ...
            $new_province->name = $provincia['name'];
            $new_province->save();
        }
        ...
        foreach ($localidades as $localidad) {
            $new_province = new Locality();
            $new_province->province_id = $localidad[0];
            $new_province->name = $localidad[1];
            $new_province->save();
        }
    }
}
